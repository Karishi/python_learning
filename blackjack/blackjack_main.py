...
while stay == False and total < 21:
    ...
    print('Your current value is ' + str(total))
    # The player has the option to make an Ace worth 11 instead of 1.
    if drawn_card[1] == 1 and (total + 10) <= 21:
        reply_bad = True
    ...
    if total > 21:
        ...
        while reply_bad: #to re-ask if you give bad input
            ...
            if hit_or_stay.capitalize() == 'S' or hit_or_stay.capitalize() == 'Stay':
                print('You decided to stay at ' + str(total) + '.')
                ...
                if dealer_val >= total and dealer_val <= 21:
                    ...
                    print('Your total of ' + str(total) + ' beats the house!')
                    win()
                stay = True
                reply_bad = False
